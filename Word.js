...
function Word(){
    this.words = ["function", "recursion", "javascript", "context","variable","scope"],
    this.randomNum = Math.floor(Math.random() * this.words.length),
    this.theWord = this.words[this.randomNum],
    this.letters = [], // Stores letter objects, generated by letter constructor
    this.numGuesses = 6,
    this.lettersGuessed = [],
...
`)
    ...
    this.guessLetter = function (letter){
        let found = false;
        for(let i=0;i<this.letters.length;i++){
            //Checks if a letter was what was guessed - if so, sets found to true
        ...
        //Checks that letter is not found yet and that letter has not already been guessed
